  ...
  return (
    <div className="flex min-h-screen flex-col">
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col px-5 md:max-w-lg md:px-0 lg:max-w-xl">
        ...
        <footer className="flex flex-wrap items-center justify-between gap-3 border-t border-[#023430] py-5 sm:gap-2 md:pb-12 md:pt-10 dark:border-[#023430]">
          ...
          <Badge
            variant={
              result === "Database connected" ? "default" : "destructive"
            }
