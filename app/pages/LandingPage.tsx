  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-black/60 backdrop-blur">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              asChild
              className="h-8 rounded-full bg-[#3B82F6] px-3 text-sm text-white hover:bg-[#2563EB]"
            >
      ...
      <section className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_60%_at_50%_20%,rgba(59,130,246,0.15)_0%,rgba(0,0,0,0.0)_60%)]" />
        <div className="mx-auto max-w-6xl px-6 pt-28 pb-16 md:pt-36 md:pb-24 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/70">
              <Heart className="h-3.5 w-3.5 text-[#3B82F6]" />
      ...
      <section id="learn-more" className="relative">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_60%_at_10%_50%,rgba(59,130,246,0.08)_0%,rgba(0,0,0,0.0)_60%)]" />
      ...
      <section className="relative">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_60%_at_80%_30%,rgba(59,130,246,0.12)_0%,rgba(0,0,0,0.0)_60%)]" />
...
const Feature = ({
  ...
  >
    <div className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/[0.06] text-[#3B82F6]">
      {icon}
    </div>
