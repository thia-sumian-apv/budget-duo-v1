...
// Modern marketing scaffold tailored to Budget Duo
// Uses new color palette: E6E6E6 (base), F7B980/ED985F (highlights), 001F3D (navy)
  ...
  return (
    <div className="min-h-screen bg-base text-navy">
        ...
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6 lg:px-8">
          <div className="flex items-center gap-6">
            ...
            <div className="hidden gap-5 text-sm text-navy/70 md:flex">
              <Link href="#learn-more" className="hover:text-navy">
                Features
              </Link>
      ...
      <section className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_60%_at_50%_20%,rgba(237,152,95,0.15)_0%,rgba(230,230,230,0.0)_60%)]" />
        <div className="mx-auto max-w-6xl px-6 pt-28 pb-16 md:pt-36 md:pb-24 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-navy/10 bg-white/50 px-3 py-1 text-xs text-navy/70">
      ...
      <section id="learn-more" className="relative">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_60%_at_10%_50%,rgba(247,185,128,0.12)_0%,rgba(230,230,230,0.0)_60%)]" />
      ...
      <section className="relative">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_60%_at_80%_30%,rgba(237,152,95,0.12)_0%,rgba(230,230,230,0.0)_60%)]" />
        <div className="mx-auto max-w-6xl px-6 pb-24 lg:px-8">
          <div className="rounded-2xl border border-navy/10 bg-white/50 p-8 md:p-12">
      ...
      <footer className="border-t border-navy/10">
        <div className="mx-auto max-w-6xl px-6 py-10 text-sm text-navy/60 lg:px-8">
...
const Feature = ({
  ...
  <motion.div
    className="rounded-xl border border-navy/10 bg-white/50 p-5"
    variants={{ hidden: { opacity: 0, y: 12 }, show: { opacity: 1, y: 0 } }}
    transition={{ duration: 0.45, ease: "easeOut" }}
  >
    <div className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-highlight-light/30 text-highlight">
      {icon}
    </div>
    <h3 className="font-heading text-base font-medium text-navy">{title}</h3>
    <p className="mt-1 text-sm text-navy/70">{desc}</p>
  </motion.div>
);
